  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary"  type="button" onclick="changePass()" class="btn btn-sm btn-success" id="create-complaints" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Procesando">Guardar</button>
