                            ...
                            <table id="tableusers" class="tablabuscadora table table-bordered table-hover ">
                                ...
                                @foreach ($bancos as $banco)
                                    <tr>
                                        <td>{{$banco->name}}</td>
                                        <td>{{$banco->nit}}</td>
                                        <td>{{$banco->name_functionary}}</td>
                                        <td>{{$banco->email}}</td>
                                        <td class="action">
                                            <form id="formdelete_{{$banco->id}}" method="POST" action="{{route('entidadesFinancieras.delete',$banco->id)}}">
                                            {{ csrf_field() }}<!--Protección de ataques laravel(token)-->
                                                {{ method_field('DELETE') }}

                                                <button class="btn btn-link" type="button" onclick="sweetDelete({{$banco->id}})" name="delete"><span class="oi oi-trash"></span></button>
